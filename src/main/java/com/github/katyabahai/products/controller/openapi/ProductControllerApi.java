...
public interface ProductControllerApi {
    ...
    @Operation(
            summary = "Получить продукты с пагинацией и скидками",
            description = "Возвращает продукты с рассчитанными скидками. Поддерживает пагинацию и фильтрацию по категории."
    )
    @ApiResponses(value = {
    ...
    ResponseEntity<Page<DiscountedProductDto>> getProducts(Category category, Pageable pageable);

    @Operation(
            summary = "Получить продукт с рассчитанной скидкой по ID",
            description = "Возвращает информацию о продукте с учетом скидки (BOOKS: 10% скидка)."
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200",
    ...
    @Operation(
            ...
            description = "Создает новый продукт. Поле description опционально. Цена должна быть больше 0."
    )
    @ApiResponses(value = {
